...
The instance is accessed **exclusively via AWS Systems Manager (SSM)** — no SSH keys, no inbound ports — reflecting modern, security-first cloud operations.

This project is designed to align with:
- Real-world Cloud / DevOps expectations
- AWS SAA-C03 concepts
- Entry-to-mid level Linux operations requirements
